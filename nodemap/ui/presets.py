...
class NODEMAP_OT_preset(AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        "settings.use_group_by_type",
        "settings.type_list_sort",
        "settings.type_list_font_size",
        "settings.type_list_width",
        "settings.type_list_height",
        "settings.type_list_position",
        "settings.show_search_bar",
        "settings.use_follow_active",
        ...
        "settings.use_passepartout",
        "settings.passepartout_alpha",
        "settings.use_custom_background",
        "settings.background_type",
        "settings.high_gradient",
        "settings.low_gradient",
