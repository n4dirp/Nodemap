...
settings.use_group_by_type = True
settings.type_list_sort = 'NAME'
settings.type_list_font_size = 11
settings.type_list_width = 160
settings.type_list_height = 160
settings.type_list_position = 'AUTO'
settings.show_search_bar = True
settings.use_follow_active = True
...
settings.passepartout_alpha = 0.4
settings.use_custom_background = True
settings.background_type = 'LINEAR'
settings.high_gradient = (0.188, 0.188, 0.188, 1.0)
settings.low_gradient = (0.1, 0.1, 0.1, 1.0)
settings.show_text_shadow = True
settings.show_node_colors = True
settings.show_wire_color = True
settings.show_dashed_wires = True
...
settings.show_wires_selected = True
